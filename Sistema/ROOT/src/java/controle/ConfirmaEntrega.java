 ...
 * @author gabri
 */
public class ConfirmaEntrega extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConfirmaEntraga</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("ok, ");
            try {
                ...
                String titulo = "Seu produto foi entregue com sucesso!";
                ...
                if (id > 0) {
                    ...
                    texto.append("<a href='https://atcawpbrasil.com.br' style='color: #312c32; text-decoration: none;'>Codigo O.S.</a>");
                    ...
                    texto.append("Seu produto foi recebido pela nossa equipe");
                    ...
                    texto.append(" Email de Contato: <br/> <a href='mailto:' style='color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;'>contato@awpbrasil.com.br</a><br/>");
