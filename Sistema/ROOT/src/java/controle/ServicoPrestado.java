 ...
 * @author gabri
 */
public class ServicoPrestado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServicoPrestado</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                String titulo = "Seu produto esta pronto!";
                ...
                if (id > 0) {
                    ...
                    texto.append("Seu produto esta pronto!");
                    ...
                    texto.append("Seu produto ja recebeu assistência<br/>");
                    texto.append("busque o na loja");
                ...
                pDAO.ConfirmaServiço(id, id_funcionario);
