 ...
 * @author gabri
 */
public class InserirValor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InserirValor</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                if (request.getMethod().equals("POST")) {
                    ...
                    texto.append("O preço do seu serviço é: <span style='color: #BDBDBD;'>R$").append(df.format(valor)).append("</span>");
                    texto.append("</div>");
                    texto.append("</td>");
                    texto.append("</tr>");
                    texto.append("<tr>");
