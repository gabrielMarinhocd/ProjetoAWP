...
public class RegistraPagamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RegistraPagamento</title>");
            out.println("</head>");
            out.println("<body>");
            try {
                int id = Integer.parseInt(request.getParameter("id"));
                String formaPagamento = (request.getParameter("formaPagamento"));
                out.println(formaPagamento);
                String recipient = request.getParameter("email");
                out.print(recipient);
                String titulo = "Seu pedido foi finalizado!";
                out.println(titulo);
                ...
                if (id > 0) {
                    ...
                    texto.append("Seu pedido foi finalizado!<br/>");
                    texto.append("Forma de Pagamento: ").append(formaPagamento);
                ...
                pDAO.registrarPag(id, formaPagamento);
