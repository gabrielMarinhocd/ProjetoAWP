...
<html>
    ...
    <body>
        ...
        <div class="central" >
            <div align="center">
                <button class="btn btn-secondary btn-sm" id="showmore">Locais</button> <button class="btn btn-secondary btn-sm" id="showmore1">Tipo de Atendimento</button>
            </div>
            <hr>

            <div class="to_show" >
                <h2 >Lista de Locais <div align="right"> <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Novo</button></div></h2>
            ...
            <div class="to_show1" >
                <h2 >Tipo de Atendimento <div align="right" > <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#inserirTP" data-whatever="@mdo">Novo</button></div></h2>
                <table class="table table-hover table-responsive-md" id="table">
                    <tr>
                        <th>Nome</th>
                        <th>Endereço</th>
