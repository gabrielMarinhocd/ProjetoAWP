...
<html>
    ...
    <body>
        ...
        <div class="container login">
           <div class="d-flex conteudo-esqueci-senha justify-content-center h-100">
             <div class="user_card">
               ...
               <div class="d-flex justify-content-center form_container">
                 <form name="login_cliente" action="valida_cliente.do" method="post">
                   <div class="input-group mb-3">
                     ...
                     <input type="email" name="email" class="form-control input_user" maxlength="40" placeholder="email"
                       required="">
                   </div>
