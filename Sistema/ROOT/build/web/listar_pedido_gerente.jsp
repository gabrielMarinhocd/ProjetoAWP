                        ...
                        <table class="table table-responsive-sm table-hover" >
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="confirma_servico.jsp?id=<%= p.getId()%>&funcionario=<%=fLogado.getId()%>&op=2&login=0"><button type="button" class="btn btn-outline-warning btn-sm btn-sm">Produto Pronto!</button></a>
                                    <% } else if (p.getFuncionario().getId() > 0 && p.getDataPagamento() == null) {%>
                                    <a href="confirma_pagamento.jsp?id=<%= p.getId()%>&op=2&login=0"><button type="button" class="btn btn-outline-info btn-sm btn-sm">Pago</button></a>
                                    <% }%>
                                    <% if (p.getDataEntrega() == null) {%>

                                    <a href="comfirma_entrega.jsp?id=<%= p.getId()%>&op=2&login=0"><button type="button" class="btn btn-outline-warning btn-sm btn-sm">Confirmar recebimento</button></a> 
                                    <% }%>
                                </td> 
                                <td>
                                    <% if (p.getAceitoValor() == null && p.getSituacao() == null) {%>
                                    <a href="#" onclick="excluir('<%=p.getCliente().getNome()%>',<%=p.getId()%>)"><button type="button" class="btn btn-outline-danger  btn-sm">Cancelar</button></a>
                                    <% }%>
                                    <a href="mostrar_pedido_fc.jsp?id=<%=p.getId()%>&idPedido=<%=p.getId()%>&op=2&login=0">
                                        ...
                                        <% if (p.getDataEntrega() != null) {%>
                                    <a href="listar_material.jsp?id=<%= p.getId()%>&op=2&login=0"><button type="button" class="btn btn-outline-warning btn-sm btn-sm">Materiais</button></a>   
                                    <% } %>
                                </td>    
                            </tr>   
                            <%
                    ...
                    <div class="table-responsive-lg table-hover">
                        <table class="table " >
                            ...
                            <tr>
                                ...
                                <td>
                                    <%if (p.getAceitoValor() != null && p.getFuncionario().getId() == 0) {%>
                                    <a href="confirma_servico.jsp?id=<%= p.getId()%>&funcionario=<%=fLogado.getId()%>&op=2&login=0">
                                    ...
                                    <a href="comfirma_entrega.jsp?id=<%= p.getId()%>&op=2&login=0"><button type="button" class="btn btn-outline-warning btn-sm btn-sm">Confirmar entrega</button></a> 
                                    <% }  %>
                                    <% if (p.getAceitoValor() == null && p.getValor() > 0 && p.getOkValor() != null) {%>
                                    <a href="aceito_valor.do?id=<%= p.getId()%>&op=2&login=0"><button type="button" class="btn btn-outline-info btn-sm btn-sm">Aceitar valor</button></a>
